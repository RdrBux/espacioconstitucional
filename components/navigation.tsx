...
export default function Navigation({ darkMode = true }: { darkMode?: boolean }) {
	return (
		<div className="absolute z-30 inset-0 container mx-auto h-fit px-4 pt-12">
			<header className={`${darkMode ? 'text-white' : 'text-slate-950'} flex items-center justify-between`}>
				...
				<nav className="hidden lg:block">
					<ul className="flex gap-3">
						...
						{/* <li>
							<Link className={`${darkMode ? "hover:border-primary-200" : "hover:border-primary-600"} px-3 py-2 border-b-2 border-transparent duration-200`} href="/publicaciones">Publicaciones</Link>
						</li> */}
						<li>
