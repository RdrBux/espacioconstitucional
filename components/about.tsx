...
export default function About() {
	return (
		<div className="bg-[#dbebea]/40">
			<section className="container mx-auto px-4 py-20 lg:py-24">
				<div className="flex items-center justify-center gap-40">
					<div className="text-lg leading-relaxed max-w-3xl 2xl:max-w-4xl">
						<div className="relative">
							<h2 className="text-4xl lg:text-5xl font-semibold font-serif">Nuestra misión y compromiso</h2>
						...
						<div className="flex items-center gap-4 relative">
							...
							<Quotes className="block text-primary-500/25 mt-2 lg:hidden absolute top-0 right-0 saturate-50" />
						</div>
					</div>
