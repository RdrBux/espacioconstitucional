...
export default function Articles() {
	return (
		<section className="container mx-auto px-4 pt-20 lg:pt-24 pb-12 lg:pb-20">
			...
			<div className="py-16 flex gap-16 lg:gap-24 2xl:gap-28 overflow-auto">
				<article className="relative w-fit h-fit shrink-0">
					<Image src="/assets/law.jpg" width={1920} height={1281} alt="" className="w-[15rem] lg:w-[22.5rem] 2xl:w-[25rem] h-[22.5rem] lg:h-[25rem] bg-black object-cover" />
					<div className="bg-white p-6 shadow-[0_5px_30px_0] shadow-[#0F172B18] w-64 lg:w-80 absolute left-8 lg:left-24 2xl:left-32 -bottom-8 lg:-bottom-12">
