		...
		<>
			<div className="container mx-auto px-4 pt-12">
				...
				<main className="my-24">
					...
					<div className="py-16 grid lg:grid-cols-3 gap-16 lg:gap-24 gap-y-24">

						<article className="relative w-fit h-fit">
							<Image src="/assets/law.jpg" width={1920} height={1281} alt="" className="h-[360px] lg:h-[400px] bg-black object-cover" />
							<div className="bg-white p-6 shadow-[0_5px_30px_0] shadow-[#0F172B18] lg:w-80 absolute left-8 right-8 lg:left-24 -bottom-8 lg:-bottom-12">
