			...
			<div className="container mx-auto px-4 pt-12">
				...
				<main className="my-24">
					<div className="relative">
						<h2 className="text-5xl lg:text-6xl font-semibold text-center font-serif">¿Quiénes somos?</h2>
						<div className="w-44 lg:w-80 h-1.5 bg-primary-200 absolute left-1/2 -translate-x-1/2 -bottom-3"></div>
					</div>

					<div className="max-w-xl mx-auto mt-16 font-serif text-slate-800 text-lg">
